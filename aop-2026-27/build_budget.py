...
("Civic & GovTech (SATARK)","SATARK Platform","New city deployments & police integration","ANPR feeds, digital billboards, campaign-rule setup & go-live support for Gurugram, Pune, Ahmedabad (the 'upcoming' cities in the SATARK briefing)",[2,6,6,6]),
...
("Hit & Run Compensation","Audit & Research","District process mapping & comparative notes","Stage-wise pipeline audit (Gurugram deep-dive) + SW Delhi/Jaipur comparative documentation",[2,3,1,1]),
...
("Civic & GovTech","NEW vertical, set at exactly Rs 1.00 Cr per Akhtar's instruction. Covers SATARK (live: Jaipur + Bengaluru; upcoming per briefing: Gurugram, Pune, Ahmedabad) + the four open data products. SATARK docs contain NO cost data - every line here is a planning assumption to be validated against actual engineering & deployment quotes."),
